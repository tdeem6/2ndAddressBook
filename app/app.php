<?php
    ...
    $app->get("/", function() use ($app) {
          ...
          return $app['twig']->render('contactinput.html.twig', array('allcontacts' => Contact::getAll()));
    });
    ...
    $app->post("/create_contact", function() use ($app) {
        ...
        return $app['twig']->render('createcontacts.html.twig', array('newcontact' => $newcontact));
    });
